...
class Kurisu(commands.Bot):
    ...
    async def load_roles(self):
        roles = ['Staff', 'Owner', 'Probation', "No-U", "NSFW Access", "User", "Announcement", "VoiceChat", "Server Booster", '🍰 birthday', "Admin", "Moderator", "No-Help", "help-mute", "meta-mute", "appeal-mute"]
