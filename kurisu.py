...
class Kurisu(commands.Bot):
    ...
    async def load_roles(self):
        roles = ['Staff', 'Owner', 'Probation', "No-U", "NSFW Access", "User", "Announcement", "VoiceChat", "Server Booster", '🍰', "Admin", "Moderator", "No-Help", "help-mute", "meta-mute", "Small Help Access", "dev-mute", "No-React"]
